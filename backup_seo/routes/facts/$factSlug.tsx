...
import { factPages } from "../../data/facts";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 md:p-12">
          ...
          <div className="bg-brand-blue/5 p-6 rounded-xl border border-brand-blue/20 mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {factPage.keyFacts.map((fact, idx) => (
                <div
                  key={idx}
                  className="flex flex-col bg-white p-4 rounded-lg border border-slate-100 shadow-sm"
                >
          ...
          <div className="mt-12 pt-8 border-t border-slate-100 text-center">
            ...
            <Link
              to="/tours"
              className="px-8 py-3 bg-brand-orange text-white font-bold rounded-lg hover:bg-brand-orange-dark transition-colors inline-block shadow-md"
            >
