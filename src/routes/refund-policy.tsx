...
export const Route = createFileRoute('/refund-policy')({
  head: () => ({
    meta: generateSEO({
      ...
      description: 'Refund Policy for Shailraj Travels. Understand our timeline and process for tour payment refunds.',
...
function RefundPolicyPage() {
  return (
    <main className="w-full bg-white pb-16 pt-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      <h1 className="text-4xl md:text-5xl font-extrabold text-brand-blue-deep mb-8">Refund Policy</h1>
      <div className="prose max-w-none text-gray-700 space-y-6">
        <p><strong>Last Updated: {new Date().toLocaleDateString()}</strong></p>
        <p>At Shailraj Travels, we aim to provide a transparent and fair refund process for our customers.</p>
        
        <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">1. Refund Eligibility</h2>
        <p>Refunds are applicable only for cancellations made within the stipulated time frame as mentioned in our Cancellation Policy. No-shows or mid-tour dropouts are not eligible for any refund.</p>

        <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">2. Refund Processing Time</h2>
        <p>Approved refunds will be processed within 7 to 10 business days. The amount will be credited back to the original mode of payment used during booking.</p>
