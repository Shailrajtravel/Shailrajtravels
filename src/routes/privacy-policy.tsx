  ...
  return (
    <main className="w-full bg-white pb-16 pt-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      ...
      <div className="prose max-w-none text-gray-700 space-y-6">
        ...
        <p>
          At Shailraj Travels, we respect your privacy and are committed to protecting your personal
          data. This Privacy Policy explains how we collect, use, and safeguard your information
          when you visit our website or use our tour services.
        </p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>Payment Information:</strong> Processed securely by our payment gateways; we do
            not store full credit card details.
          </li>
          <li>
            <strong>Usage Data:</strong> Information about your interactions with our website for
            analytics purposes.
          </li>
        </ul>
        ...
        <p>
          ...
          shailrajtravels9999@gmail.com or call us at +91 97634 33556.
        </p>
      </div>
    </main>
  );
