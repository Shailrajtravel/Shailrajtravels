...
export const Route = createFileRoute("/authors")({
  head: () => ({
    meta: generateSEO({
      ...
      description:
        "Meet the expert pilgrimage guides, itinerary planners, and authors behind Shailraj Travels.",
      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Our content is written and fact-checked by veteran tour guides and pilgrimage planners
            with decades of on-ground experience.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {Object.values(authors).map((author) => (
            ...
            >
              ...
              <div className="text-brand-orange font-bold text-sm uppercase tracking-wider mb-4">
                {author.role}
              </div>
              ...
              <div className="mt-auto pt-6 border-t border-slate-100 w-full flex justify-between items-center">
                ...
                <Link
                  to={`/author/${author.id}`}
                  className="text-brand-blue-deep font-bold hover:text-brand-orange transition-colors"
                >
