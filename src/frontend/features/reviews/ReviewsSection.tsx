...
const MOCK_REVIEWS = [
  {
    ...
    textMr:
      "शैलराज ट्रॅव्हल्सची सेवा अतिशय उत्तम आहे. अष्टविनायक यात्रा खूप चांगल्या प्रकारे आयोजित केली होती, हॉटेल्स स्वच्छ होती आणि जेवण अप्रतिम होते. कौटुंबिक सहलींसाठी मी नक्की शिफारस करेन.",
  },
  {
    id: 2,
    name: "Priya Kulkarni",
    ...
    textMr:
      "आम्ही शैलराज ट्रॅव्हल्ससोबत उज्जैन महाकालला गेलो होतो. टूर मॅनेजर अतिशय नम्र आणि मदत करणारे होते. दर्शन अगदी सुरळीत झाले. पुण्यातील सर्वोत्तम ट्रॅव्हल एजन्सी!",
  },
  {
    id: 3,
    name: "Rahul Patil",
    ...
    textMr:
      "अतिशय आरामदायी प्रवास आणि सुरक्षित ड्रायव्हिंग. एसी कोच खूप छान होता. एका सुंदर आध्यात्मिक अनुभवासाठी धन्यवाद.",
  },
];
...
export function ReviewsSection({ lang, t }: { lang: "mr" | "en"; t: any }) {
  ...
  return (
    <section
      id="reviews"
      className="w-full bg-white py-12 lg:py-20 relative scroll-mt-28 md:scroll-mt-32 overflow-hidden"
    >
      {/* Toast Notification */}
      <div
        className={`fixed bottom-8 left-1/2 -translate-x-1/2 z-[100] bg-brand-green text-white px-6 py-3.5 rounded-full font-bold shadow-2xl transition-all duration-500 flex items-center gap-2 ${showToast ? "translate-y-0 opacity-100" : "translate-y-24 opacity-0"}`}
      >
              ...
              >
                ...
                <div className="flex justify-center gap-2 mb-2">
                  {[1, 2, 3, 4, 5].map((star) => (
                    ...
                    >
                      <Star
                        className={`w-8 h-8 ${rating >= star ? "fill-[#F59E0B] text-[#F59E0B]" : "fill-slate-100 text-slate-200"} transition-colors`}
                      />
                    </button>
                  ))}
                </div>
            ...
            {displayReviews.map((r: any) => {
              ...
              return (
                <div
                  ...
                  className="bg-white rounded-[24px] p-6 sm:p-8 border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col"
                >
                  <div className="flex justify-between items-start mb-6">
                    <div className="flex gap-1 text-[#F59E0B]">
                      {[...Array(5)].map((_, i) => (
                        <Star
                          key={i}
                          className={`w-5 h-5 ${i < (review.rating || 5) ? "fill-current" : "fill-slate-100 text-slate-200"}`}
                        />
                      ))}
                    </div>
