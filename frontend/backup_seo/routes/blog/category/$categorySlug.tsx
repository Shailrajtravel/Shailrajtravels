  ...
  head: ({ loaderData }) => {
    ...
    return {
      ...
      links: [
        {
          rel: "canonical",
          href: `https://www.shailrajtravels.com/blog/category/${categoryName.toLowerCase().replace(/\s+/g, "-")}`,
        },
        ...generateHreflangLinks(
          `https://www.shailrajtravels.com/blog/category/${categoryName.toLowerCase().replace(/\s+/g, "-")}`,
        ),
      ],
    };
  },
