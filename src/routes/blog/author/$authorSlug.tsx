        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 border border-slate-100 shadow-sm mb-16 animate-reveal flex flex-col md:flex-row items-center md:items-start gap-8 text-center md:text-left">
          {author.avatarUrl ? (
            <img
              ...
              alt={author.name}
              className="w-32 h-32 md:w-40 md:h-40 rounded-full object-cover border-4 border-slate-50 shadow-md flex-shrink-0"
            />
          ) : (
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-600 text-lg max-w-3xl leading-relaxed">{author.bio}</p>
          </div>
        </div>

        {/* Header */}
        <div className="mb-12 border-b border-slate-200 pb-4 animate-reveal">
          <h2 className="text-2xl font-bold text-brand-blue-deep">Articles by {author.name}</h2>
        </div>
