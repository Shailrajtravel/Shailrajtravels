    ...
    <section className="py-16 bg-white overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-4 md:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-display font-bold text-brand-blue-deep mb-4">Memories of Our Yatris</h2>
          <p className="text-slate-600 max-w-2xl mx-auto">See the smiles of thousands of families who trusted us with their spiritual journeys.</p>
        </div>
