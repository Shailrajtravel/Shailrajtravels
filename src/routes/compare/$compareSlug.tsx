...
export const Route = createFileRoute("/compare/$compareSlug")({
  ...
  head: ({ loaderData }) => ({
    ...
    links: [
      { rel: "canonical", href: `https://www.shailrajtravels.com/compare/${loaderData.c.slug}` },
    ],
  }),
...
function ComparePageTemplate() {
  ...
  if (!tour1 || !tour2) {
    return (
      <div className="p-8 text-center text-red-500">Error: Tours not found for this comparison</div>
    );
  }
